...
int main()
{
    ...
    char tmpHello[]         = "Hello world\r\n";
    char tmpK1921VG015[]    = "Hello K1921VG015\r\n";
    uart_0->transmitPolling((uint8_t*)tmpHello, sizeof("Hello world\r\n"), nullptr);
    uart_0->transmit((uint8_t*)tmpK1921VG015, sizeof(tmpK1921VG015), nullptr);
    ...
    char tmpBuf[14] = {};
    uart_0->receivePolling((uint8_t*)tmpBuf, (sizeof(tmpBuf) - 1), nullptr);
    printf("bufRX::\t%s\r\n", tmpBuf);

    memset(tmpBuf,0,sizeof(tmpBuf));
    uart_0->receive((uint8_t*)tmpBuf, (sizeof(tmpBuf) - 1), nullptr);
    printf("bufRX::\t%s\r\n", tmpBuf);

    /** @note input 1024 bytes */
    memset(tmpBuf,0,sizeof(tmpBuf));
    scanf("%8s", tmpBuf);
    printf("bufRX::\t%s\r\n", tmpBuf);
